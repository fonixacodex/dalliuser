...
export default function VerifyOtpForm({
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-row-reverse justify-center gap-2 sm:gap-3 md:gap-4">
                {otp.map((digit, index) => (
                    <input
                        key={index}
                        ref={(el) => {
            ...
            <button onClick={onBack}
                    className="w-full py-2 text-gray-500 text-sm flex items-center justify-center gap-2 hover:text-gray-700 transition-colors">
